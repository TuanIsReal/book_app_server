...
public class Constant {
    public static final String BOOK_IMAGE_STORAGE_PATH = "C:/inetpub/wwwroot/image/";
    public static final String THUMBNAIL_STORAGE_PATH = "C:/inetpub/wwwroot/thumbnail/";
    public static final String AVATAR_IMAGE_STORAGE_PATH = "C:/inetpub/wwwroot/avatar/";
    public static final String CHAPTER_TEXT_STORAGE_PATH = "C:/chapter/";
    public static final String JPG = ".jpg";
    public static final String TXT = ".txt";
    public static final String BOOK_IMAGE_STORAGE_PATH_RESPONSE = "/image/";
    public static final String THUMBNAIL_STORAGE_PATH_RESPONSE = "/thumbnail/";
    public static final String AVATAR_IMAGE_STORAGE_PATH_RESPONSE = "/avatar/";
